  ...
  return (
    ...
    >
      <path
        ...
        className={clsx(
          "fill-[#BABABB] transition-all group-hover:fill-[#494949] dark:fill-[#5e5e5e] dark:group-hover:fill-[#d6d6d6]",
      ...
      <path
        ...
        className={clsx(
          "fill-[#5B5966] transition-all group-hover:fill-[#BD8AFF] dark:fill-[#c9c9c9] dark:group-hover:fill-[#9e9e9e] ",
          { "fill-[#e9e9e9] dark:!fill-[#3d3d3d] ": selected },
        )}
      />
    </svg>
  );
